...
if [ "${caseType}" == "cputest" ];then
    ...
    load_testcase ${serverHost} ${serverPass}  "2016-01-01T00:00:00Z" "2016-01-02T00:00:00Z"  "100 4000 100000 1000000 10000000" "cpu-only" "${load_number_workers}" "${load_batchsizes}" "TDengineStmt2 timescaledb influx" 

elif [ "${caseType}" == "devops" ];then
    load_testcase ${serverHost} ${serverPass}  "2016-01-01T00:00:00Z" "2016-01-02T00:00:00Z"  "100 4000 100000 1000000 10000000"  "devops" "${load_number_workers}" "${load_batchsizes}" "TDengineStmt2 timescaledb influx"

elif [ "${caseType}" == "iot" ];then
    load_testcase ${serverHost} ${serverPass}  "2016-01-01T00:00:00Z" "2016-01-02T00:00:00Z"  "100 4000 100000 1000000 10000000" "iot" "${load_number_workers}" "${load_batchsizes}" "TDengineStmt2 timescaledb influx"
