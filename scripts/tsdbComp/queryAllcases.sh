...
if [ ${caseType} == "cputest" ];then
    ...
    query_testcase ${serverHost} ${serverPass}  "2016-01-01T00:00:00Z"  "2016-01-05T00:00:00Z" "2016-01-05T00:00:01Z"  "4000"  "iot" "${query_number_wokers}" "timescaledb influx"  "${query_times}"
